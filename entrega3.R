...
colnames(W) <- c("Core", "Non core", "Goods", "Financials", 
                 "Industrials", "Equally")
...
results_2 <- rbind(alpha, B_all, total_var, var_sys_all_perc, var_idio_all_perc)
# Results in LaTeX:
...
results_2c <- rbind(alpha2, B_all2, total_var2, var_sys_all2_perc, 
                    var_idio_all_perc)
# Results in LaTeX:
...
rownames(var_idio_all_gls2) <- "Idio var"
total_var_gls2 <- var_sys_all_gls2 + var_idio_all_gls2
rownames(total_var_gls2) <- "Total var"

var_sys_all_gls2_perc <- (var_sys_all_gls2/total_var_gls2)*100
var_idio_all_gls2_perc <- (var_idio_all_gls2/total_var_gls2)*100

results_3b_gls <- rbind(total_var_gls2, var_sys_all_gls2_perc,
                        var_idio_all_gls2_perc, B_barra_all2)
# Results in LaTeX:
